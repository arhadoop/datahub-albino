 ...
 */
package com.acme.albino.test.setup;
...
import com.acme.albino.test.constants.AlbinoTestConstants;
import com.acme.albino.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AlbinoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/albinotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/albinotest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/albinotest/import/cstickets.impex");
			...
			importImpexFile(context, "/albinotest/import/csquotes.impex");
		}
	}
}
