 ...
 */
package com.acme.albino.cockpits.setup;
...
import com.acme.albino.cockpits.constants.AlbinoCockpitsConstants;
 ...
 */
@SystemSetup(extension = AlbinoCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AlbinoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AlbinoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AlbinoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/albinocockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
