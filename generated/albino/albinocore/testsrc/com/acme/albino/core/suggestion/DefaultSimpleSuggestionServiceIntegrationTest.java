 ...
 */
package com.acme.albino.core.suggestion;
...
import com.acme.albino.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/albinocore/test/testSimpleSuggestionService.csv", "utf-8");
	}
