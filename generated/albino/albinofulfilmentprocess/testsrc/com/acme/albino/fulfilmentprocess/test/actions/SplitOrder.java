 ...
 */
package com.acme.albino.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AlbinoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AlbinoFulfilmentProcessConstants.PARENT_PROCESS);
