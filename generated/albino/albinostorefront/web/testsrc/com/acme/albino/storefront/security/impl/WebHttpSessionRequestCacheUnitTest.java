...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/albinostorefront/electronics/en",
						"https://electronics.local:9002/albinostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/albinostorefront/electronics/en",
						"https://electronics.local:9002/albinostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/albinostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/albinostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/albinostorefront/electronics/en",
						"https://electronics.local:9002/albinostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/albinostorefront",
						"https://electronics.local:9002/albinostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/albinostorefront",
						"https://electronics.local:9002/albinostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/albinostorefront/electronics/en",
						"https://electronics.local:9002/albinostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
